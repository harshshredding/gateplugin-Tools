 ...
 *
 *  $Id: DumpingPR.java 19748 2016-11-18 04:23:17Z markagreenwood $
 */
 ...
 */
@CreoleResource(name="Flexible Exporter", comment="Exports a document with GATE annotations to its original format.", helpURL="http://gate.ac.uk/userguide/sec:misc-creole:flexexport")
public class DumpingPR extends AbstractLanguageAnalyser {
  ...
  */
  ...
  @RunTime
  @Optional
  @CreoleParameter(comment="The url of the output directory. If not provided, use the temporary directory.", suffixes="xml;html;txt")
  public void setOutputDirectoryUrl(URL file) {
    this.outputDirectoryUrl = file;
  }

  @Optional
  @CreoleParameter(comment="Whether or not to include features when exporting the GATE annotations")
  ...
  @Optional
  @CreoleParameter(comment="Whether to export to stand-off XML rather than inline annotations", defaultValue="false")
  ...
  @Optional
  @CreoleParameter(comment="The suffix used for files, if suffix adding is set to true", defaultValue=".gate")
  ...
  @Optional
  @CreoleParameter(comment="Whether or not to use a suffix for the dump files", defaultValue="true")
