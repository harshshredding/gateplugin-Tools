...
@CreoleResource(name="Gazetteer List Collector",comment="Gazetteer lists collector.", helpURL="http://gate.ac.uk/userguide/sec:gazetteers:listscollector")
public class GazetteerListsCollector extends AbstractLanguageAnalyser {
  ...
  @Optional
  @RunTime
  @CreoleParameter(defaultValue="Organization;Person;Location;Date")
